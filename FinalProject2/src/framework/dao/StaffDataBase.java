...
public class StaffDataBase implements Aggregate {
	...
	/*
	 * CREATE TABLE bankdb.bankstaff (fname VARCHAR(20)， lname VARCHAR(20), age int(4),gender VARCHAR(10),
	 * pwd VARCHAR(20), username VARCHAR(20)));
	 * 
	 * */
	// alter table bankdb.bankstaff  add staffType VARCHAR(20) after username;
//	CREATE TABLE bankdb.bankstaff (fname VARCHAR(20), lname VARCHAR(20), age int(4),gender VARCHAR(10),
//			  password VARCHAR(20), username VARCHAR(20));
//	insert into bankdb.bankstaff values("root","1234",21,"Lei","Chen","Male");
